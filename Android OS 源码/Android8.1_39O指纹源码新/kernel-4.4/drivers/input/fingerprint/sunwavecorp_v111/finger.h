...
#define  sw_dbg(fmt, args...)     do{if(sunwave_debug_level){  printk("sunwave: " _DRV_TAG_ " [%s %d] " fmt " \n", __func__,__LINE__, ##args);}}while(0)
#define  sw_info(fmt, args...)    do{printk("sunwave: " _DRV_TAG_ " [%s %d] " fmt " \n", __func__,__LINE__, ##args);}while(0)
#define  sw_err(fmt, args...)     do{printk(KERN_ERR"sunwave: error: " _DRV_TAG_ " [%s %d] " fmt " \n", __func__,__LINE__, ##args);}while(0)
