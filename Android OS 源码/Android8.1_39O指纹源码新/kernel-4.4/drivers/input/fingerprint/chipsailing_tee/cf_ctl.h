...
#define CS_DRV_DTS_NAME        "mediatek,cs_finger" //"chipsailing_finger,SC338P_FP"  //"mediatek,cs_finger"
#define SLAVE_SPI_DEV_NODE_DTS_NAME        "mediatek,chipsailing_fp"  //"mediatek,chipsailing_fp" 

#define CS_INT_PIN_PROPERTY        "chipsailing,gpio_irq" //"finger_int_pin" //"gpio-irq-std"  "fingerprint,touch-int-gpio" 
#define CS_RST_PIN_PROPERTY        "chipsailing,gpio_rst" 
#define CS_PWR_PIN_PROPERTY        "chipsailing,gpio_pwr" 
...
//#define CF_IOC_ENABLE_CS   _IO(CF_IOC_MAGIC, 0x70)
//#define CF_IOC_DISABLE_CS   _IO(CF_IOC_MAGIC, 0x80)
