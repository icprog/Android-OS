...
#if 0//defined(YK668_DTV_FINGER_SUPPORT)
	#include "mt_gpio.h"
	#define GPIO_CS_PIN        		(8 | 0x80000000)
	#define GPIO_SPI_CS_PIN        		(65 | 0x80000000)
#endif
...
static int cf_sync_read_and_write(struct spi_device *spi, struct spi_message *message)
{
	...
	#if 0//defined(YK668_DTV_FINGER_SUPPORT) //zwl
		mt_set_gpio_mode(GPIO_CS_PIN,0);
		mt_set_gpio_dir(GPIO_CS_PIN,GPIO_DIR_OUT);
		mt_set_gpio_out(GPIO_CS_PIN, 0);
