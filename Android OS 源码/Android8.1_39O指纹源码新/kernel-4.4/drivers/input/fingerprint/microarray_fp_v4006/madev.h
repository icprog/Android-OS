...
#define FINGERPRINT_TAP 				KEY_F10 //KEY_FN_F5//	831
...
extern int init_connect(unsigned int *chip_id);
//end

//use for the log print
#define MALOG_TAG "[MICROARRAY_FP]"
#define MALOGE(format, args...)   pr_err(MALOG_TAG "[%s %d]: error " format, __func__, __LINE__, ##args);  	 //error log
#define MALOGF(format, args...)   pr_err(MALOG_TAG "[%s %d]: debug " format, __func__, __LINE__, ##args);	 //flag log
#define MALOGD         MALOGF																				 //debug log
#define MALOGW(format, args...)   pr_err(MALOG_TAG "[%s %d]: warning " format, __func__, __LINE__, ##args);  //warning log
//use for the log print
