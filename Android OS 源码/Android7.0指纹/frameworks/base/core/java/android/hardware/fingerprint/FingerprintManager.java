...
public class FingerprintManager {
	...
	/*add by lichengfeng */
    public static final String SETTINGS_KEY_USEDTO_SCREENLOCK = "com_bird_fingerprint_usedto_screenlock";//screen lock
    public static final String SETTINGS_KEY_USEDTO_APPLOCK = "com_bird_fingerprint_usedto_applock";//app lock
    public static final String SETTINGS_NEEDLOCK_APP_PACKAGENAMES = "com_bird_fingerprintunlock_needlockapp_package";
    public static final String SETTINGS_LAST_LOCK_APP_PACKAGENAME = "com_bird_fingerprintunlock_lastapp_package";	
	/*add by lichengfeng */
   ...
   /**
	 ...
	 * finger up & down 
	 */
	public static final int FINGERPRINT_ACQUIRED_FINGER_UP = 1101;
	public static final int FINGERPRINT_ACQUIRED_FINGER_DOWN = 1102;
	
	/*
	 * duplicate fingerprint
	 */
	public static final int FINGERPRINT_ACQUIRED_DUPLICATE_FINGER = 1105;
	public static final int FINGERPRINT_ACQUIRED_DUPLICATE_AREA = 1106;
	...
	public boolean getFingerprintIPOState() {
		android.util.Log.e("lcf_finger", "FingerprintManager getFingerprintIPOState mService: "+mService);
        if (mService != null) try {
			boolean fingerprintIPOState = mService.getFingerprintIPOState();
			android.util.Log.e("lcf_finger", "FingerprintManager fingerprintIPOState: " + fingerprintIPOState);
			return fingerprintIPOState;
	...
	public int getFingerprintFailedAttempts() {
		//android.util.Log.e("lcf_finger", "FingerprintManager getFingerprintFailedAttempts mService: "+mService);
        if (mService != null) try {
			int fingerprintFailedAttempts = mService.getFingerprintFailedAttempts();
			//android.util.Log.e("lcf_finger", "FingerprintManager getFingerprintFailedAttempts: " + fingerprintFailedAttempts);
			return fingerprintFailedAttempts;
        } catch (RemoteException e) {
            Log.w(TAG, "Remote exception while authenticating: ", e);
        }
		return -1;
    ...
    public static abstract class LockoutResetCallback {
		...
		public void lockoutRemainingTime(int lockoutRemaingTime) { }
        ...
        if (mService != null) {
            try {
                ...
                mService.addLockoutResetCallback(
					...
					// @ bird { add by lichengfeng 20160816 begin }
					@Override
                    public void lockoutRemainingTime(final int lockoutRemaingTime) throws RemoteException {
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                try {
                                    callback.lockoutRemainingTime(lockoutRemaingTime);
                                } finally {
									android.util.Log.v("lcf_finger", "in addLockoutResetCallback() lockoutRemaingTime is : "+ lockoutRemaingTime);
                                }
                            }
                        });
                    }
    ...
    private String getAcquiredString(int acquireInfo) {
        switch (acquireInfo) {
			...
			// bird @ { add by lichengfeng 20160718 begin
