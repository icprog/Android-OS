...
# bird wangdong@szba-mobile.com   add start 201710211110 
BIRD_INTERNAL_CDEFS := $(foreach t,$(BIRD_AUTO_ADD_GLOBAL_DEFINE_BY_NAME),$(if $(filter-out no NO none NONE false FALSE,$($(t))),-D$(t)))
BIRD_INTERNAL_CDEFS += $(foreach t,$(BIRD_AUTO_ADD_GLOBAL_DEFINE_BY_VALUE),$(if $(filter-out no NO none NONE false FALSE,$($(t))),$(foreach v,$(shell echo $($(t)) | tr '[a-z]' '[A-Z]'),-D$(v))))
BIRD_INTERNAL_CDEFS += $(foreach t,$(BIRD_AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(if $(filter-out no NO none NONE false FALSE,$($(t))),-D$(t)=\"$($(t))\"))

COMMON_GLOBAL_CFLAGS += $(BIRD_INTERNAL_CDEFS)
COMMON_GLOBAL_CPPFLAGS += $(BIRD_INTERNAL_CDEFS)
# bird wangdong@szba-mobile.com   add end 201710211110 
