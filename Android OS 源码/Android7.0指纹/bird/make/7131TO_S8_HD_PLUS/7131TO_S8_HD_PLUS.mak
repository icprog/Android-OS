...
BIRD_AUTO_ADD_GLOBAL_DEFINE_BY_NAME = BIRD_FINGERPRINT_USE_REE_MODE
BOOT_LOGO = hdplus
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_HAL_IMGSENSOR = s5k4h8_mipi_raw gc2385_mipi_raw
...
CUSTOM_HAL_MSENSORLIB = mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md qmc5983 akmd09911 mc64xx bmm056 mc41xx akmd09918
...
CUSTOM_KERNEL_IMGSENSOR = s5k4h8_mipi_raw gc2385_mipi_raw
...
CUSTOM_MODEM = 7131TO_P9_2G_B2B3B8_W_B1B2B5_TDS_A_F_4G_B3B7B8B34B38B39B40B41_BC0_MP_1107
...
MTK_BUILD_VERNO = alps-mp-n1.mp18-V2_bd6739.36.a.n1
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 2
...
#CREATE_PROJECT_INFO=20171211173413



#-------------------------- BIRD ADD BEGIN ------------------------
BIRD_CUSTOM = 7131TO_S8_HD_PLUS

#BIRD_ONLY_INTERNAL_SD =yes

#--------------------------IMGSENSOR------------------------
BIRD_MAIN_IMGSENSOR = s5k4h8_mipi_raw_7131SO7_S8_RK_35G_MV88
BIRD_MAIN_LENS = dw9714af_7131SO7_S8_RK_35G_MV88
#BIRD_MAIN_BACKUP_IMGSENSOR =
BIRD_SUB_IMGSENSOR = gc2385_mipi_raw_7131SO7_S8_RK_35G_MV88
#BIRD_SUB_BACKUP_IMGSENSOR = 

#--------------------------IMGSENSOR end------------------------
#-------------bird config--------------
#BIRD_TP_SMART_WAKE = 1 //2open,1close
#BIRD_TP_SMART_WAKE_QUICK_GESTURE = 1
#BIRD_TP_SMART_GESTURE_DOUBLETAP = 1
#BIRD_TP_SMART_GESTURE_SLIDE_LEFT = 1
#BIRD_TP_SMART_GESTURE_SLIDE_RIGHT = 1
#BIRD_TP_SMART_GESTURE_SLIDE_UP = 1
#BIRD_TP_SMART_GESTURE_SLIDE_DOWN = 1
#BIRD_TP_SMART_GESTURE_C = 1
#BIRD_TP_SMART_GESTURE_E = 1
#BIRD_TP_SMART_GESTURE_M = 1
#BIRD_TP_SMART_GESTURE_O = 1
#BIRD_TP_SMART_GESTURE_S = 1
#BIRD_TP_SMART_GESTURE_V = 1
#BIRD_TP_SMART_GESTURE_W = 1
#BIRD_TP_SMART_GESTURE_Z = 1
...
BIRD_FACTORY_AUTO_TEST_HEADSET 	=yes
BIRD_FACTORY_AUTO_TEST_MMI_KEY 	=yes
BIRD_FACTORY_BATTERY_FD 	=no
BIRD_FACTORY_GSENSOR_FD 	=no
BIRD_FACTORY_POWERON_TEST_NFC 	=no
BIRD_FACTORY_POWERON_TEST_OTG 	=no
BIRD_FACTORY_POWERON_TEST_FINGERPRINT =yes
BIRD_FACTORY_POWERON_TEST_GYROSCOPE_VALUES =yes
#bwg
#BIRD_FACTORY_POWERON_TEST_GYROSCOPE = yes
BIRD_FACTORY_POWERON_TEST_MSENSOR =yes
#OTG
BIRD_FACTORY_POWERON_TEST_OTG =yes
BIRD_MMITEST_OTG_FD=yes
#TIPLAMP
BIRD_FACTORY_POWERON_TEST_TIPLAMP = yes
BIRD_TEST_GREEN_LED=yes
BIRD_FACTORY_POWERON_BACK_LIGHT=yes
#--------------------------FactoryTest end------------------------
...
BIRD_MMI_BACKLIGHT_FD   	=yes
BIRD_MMI_AUTO_TEST_LIGHT_SENSOR  	=yes
BIRD_MMI_AUTO_TEST_PROXIMITY  	=yes
BIRD_MMITEST_DOOV_TEST_SENSOR  	=yes
BIRD_MMI_PSENSOR_FD   	=yes
BIRD_MMI_AUTO_TEST_GPS  	=yes
BIRD_MMITEST_GPS_FD  	=yes
BIRD_MMI_AUTO_TEST_TIPLAMP  	=no
BIRD_MMI_AUTO_TEST_KEYBOARDLED  	=yes
BIRD_MMI_HEADSETKEY_FD   	=yes
BIRD_MMI_AUTO_TEST_HALL  	=no
BIRD_MMITEST_HALL_FD   	=no
BIRD_MMI_AUTO_TEST_COMPASS  	=no
BIRD_MMI_AUTO_TEST_FINGERPRINT  	=no
BIRD_MMI_AUTO_TEST_FINGERPRINT_WITH_PICTURE  	=no
BIRD_MMITEST_FINGERPRINT_FD   	=no
BIRD_MMI_AUTO_TEST_GYROSCOPE  	=no
BIRD_MMI_AUTO_TEST_NFC  	=no
BIRD_MMI_AUTO_TEST_OTG  	=no
#BIRD_MMITEST_OTG_FD   	=no
BIRD_MMI_TEST_KEYBOARD_SAMSUNG  	=no
BIRD_MMI_TFLASH_FD   	=yes
BIRD_MMITEST_DOOV_SMT_BT_FT     	=no
BIRD_MMITEST_MP3_RES   	=no
BIRD_MMITEST_TPDRAW_FWVGA  	=no
BIRD_MMITEST_VIEW_HARDWAREINFO  	=no
BIRD_MMI_AUTO_TEST_DIAL112  	=no
BIRD_MMI_AUTO_TEST_GYROSCOPE=yes
BIRD_MMI_AUTO_TEST_FINGERPRINT_WITH_PICTURE=yes
BIRD_MMITEST_FINGERPRINT_FD=yes
#--------------------------MMITest end------------------------

#--------------------------Fingerprint begin------------------------
BIRD_SUPPORT_FP_CHIP = cdfinger
BIRD_SUPPORT_FP_SENSOR = fps988e
BIRD_FINGERPRINT_USE_REE_MODE = yes
#--------------------------Fingerprint end--------------------------
