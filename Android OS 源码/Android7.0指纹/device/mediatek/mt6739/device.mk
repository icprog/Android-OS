...
PRODUCT_PACKAGES += libaudio.r_submix.mt6739
PRODUCT_PACKAGES += libaudio.r_submix.mt6739m
...
PRODUCT_PACKAGES += perf_whitelist_cfg.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/mpe/etc/mpe.conf:$(TARGET_COPY_OUT_VENDOR)/etc/mpe.conf:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.mt6739.rc:root/init.mt6739.rc
PRODUCT_COPY_FILES += device/mediatek/mt6739/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.modem.rc:root/init.modem.rc
ifeq ($(strip $(MTK_EMMC_SUPPORT)),yes)
...
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.fon.rc:root/init.fon.rc
endif

ifeq ($(strip $(MTK_SENSOR_BIO)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.sensor_bio.rc:root/init.sensor_bio.rc
endif

ifneq ($(strip $(MTK_SENSOR_BIO)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.sensor.rc:root/init.sensor.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt6739/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6739/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.mt6739.usb.rc:root/init.mt6739.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6739/init.recovery.mt6739.rc:root/init.recovery.mt6739.rc
...
PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs.xml:system/etc/media_codecs.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_tablet.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_phone.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_basic.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
endif

PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk
...
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6739/init.trustonic.rc:root/init.trustonic.rc
...
# Add for mtk modified skia
PRODUCT_PACKAGES += libskia_mtk
...
# bird add
include device/mediatek/mt6739/bird.mk
#inherit fingerprint.mk
#include device/mediatek/mt6739/fingerprint.mk OK
